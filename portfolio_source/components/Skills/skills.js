  ...
  <svg viewBox="0 0 128 128" style={{width: '100%', height: '100%'}}>
    <defs>
      <radialGradient id="b" cx="9.36" cy="10.57" fx="9.36" fy="10.57" r="7.07" gradientTransform="matrix(73.03125 0 0 37.1875 29.797 56.535)">
        <stop offset="0" style={{stopColor:'#f2f2f2',stopOpacity:1}}></stop>
        <stop offset=".58" style={{stopColor:'#eee',stopOpacity:1}}></stop>
        <stop offset="1" style={{stopColor:'#e6e6e6',stopOpacity:1}}></stop>
      </radialGradient>
      <linearGradient id="a" gradientUnits="userSpaceOnUse" x1="2.59" y1="10.16" x2="15.41" y2="10.16" gradientTransform="scale(7.11111)">
        <stop offset="0" style={{stopColor:'#005ba1',stopOpacity:1}}></stop>
        <stop offset=".07" style={{stopColor:'#0060a9',stopOpacity:1}}></stop>
        <stop offset=".36" style={{stopColor:'#0071c8',stopOpacity:1}}></stop>
        <stop offset=".52" style={{stopColor:'#0078d4',stopOpacity:1}}></stop>
        <stop offset=".64" style={{stopColor:'#0074cd',stopOpacity:1}}></stop>
        <stop offset=".82" style={{stopColor:'#006abb',stopOpacity:1}}></stop>
        <stop offset="1" style={{stopColor:'#005ba1',stopOpacity:1}}></stop>
      </linearGradient>
    </defs>
    <path style={{stroke:'none',fillRule:'nonzero',fill:'url(#a)'}} d="M64 36.55c-25.172 0-45.582-7.109-45.582-16.495v87.89c0 9.032 20.055 16.356 44.941 16.5H64c25.172 0 45.582-7.113 45.582-16.5v-87.89c0 9.172-20.41 16.496-45.582 16.496Zm0 0"></path>
    <path style={{stroke:'none',fillRule:'nonzero',fill:'#e8e8e8',fillOpacity:1}} d="M109.582 20.055c0 9.172-20.41 16.496-45.582 16.496s-45.582-7.11-45.582-16.496c0-9.387 20.41-16.5 45.582-16.5s45.582 7.113 45.582 16.5"></path>
    <path style={{stroke:'none',fillRule:'nonzero',fill:'#50e6ff',fillOpacity:1}} d="M98.988 18.703c0 5.832-15.718 10.524-34.988 10.524s-34.988-4.692-34.988-10.524C29.012 12.871 44.73 8.25 64 8.25s34.988 4.691 34.988 10.453"></path>
    <path style={{stroke:'none',fillRule:'nonzero',fill:'#198ab3',fillOpacity:1}} d="M64 21.332a82.193 82.193 0 0 0-27.664 4.055A81.213 81.213 0 0 0 64 29.227a79.334 79.334 0 0 0 27.664-4.125A84.332 84.332 0 0 0 64 21.332Zm0 0"></path>
...
const PyTorchIcon = () => (
  <svg viewBox="0 0 128 128" style={{width: '100%', height: '100%'}}>
    <path fill="#EE4C2C" d="M100.1 38.3l-9.2 9.2c15.1 15.1 15.1 39.4 0 54.3-15.1 15.1-39.4 15.1-54.3 0-15.1-15.1-15.1-39.4 0-54.3l24-24 3.4-3.4V2L27.8 38.2C7.7 58.3 7.7 90.8 27.8 111s52.6 20.1 72.4 0c20.1-20.2 20.1-52.5-.1-72.7z"></path>
    <circle fill="#EE4C2C" transform="rotate(-88.939 82.069 29.398) scale(.99997)" cx="82.1" cy="29.4" r="6.7"></circle>
  </svg>
);

const NumPyIcon = () => (
  <svg viewBox="0 0 128 128" style={{width: '100%', height: '100%'}}>
    <path fill="#4dabcf" d="M64.113 0 43.6 10.24l21.37 10.774L84.854 10.4 64.114 0zm-30.48 15.217-23.479 11.71 21.969 11.03 22.889-11.951-21.38-10.79zm61.135.158L74.734 25.938 97.2 37.272l20.606-10.344-23.037-11.553zM64.82 30.957 41.982 42.912l22 11.043 23.26-11.676L64.82 30.957zM4.115 33.32v64.977l15.041 8.064v-33.98s20.477 39.348 20.688 39.781c.213.43 2.257 4.569 4.459 6.027 2.92 1.94 15.459 9.48 15.459 9.48l.008-65.952-16.918-8.512v36.766s-20.7-44.034-22.612-47.993c-.246-.512-1.263-1.07-1.521-1.209-3.732-1.947-14.604-7.449-14.604-7.449zm119.77.928-21.471 10.674.018 28.068 21.453-10.9V34.248zm-30.186 15.01L68.64 61.717V89.74l25.088-12.47-.028-28.012zm30.186 22.765-21.447 10.823.017 28.277 21.43-10.69v-28.41zm-30.147 15.13L68.638 99.7V128l25.124-12.537-.024-28.31z"></path>
  </svg>
);
...
const Skills = () => {
  ...
  // Helper function to convert percentage to dots (1-5)
  const getProficiencyDots = (percentage) => {
    const dots = Math.round((percentage / 100) * 5) || 1;
    return Array(5).fill(0).map((_, i) => (
      <span key={i} className={`proficiencyDot ${i < dots ? 'filled' : ''}`}>●</span>
    ));
  };
  ...
  return (
    <>
      <section id='proficiency' ref={sectionRef} className={isVisible ? 'visible' : ''}>
        ...
        <div className='skillsContainer'>
          ...
          <div className='skillsCategory'>
            ...
            <div className='skillsList'>
              <div className='language'>
                ...
                <div className='proficiencyDots'>{getProficiencyDots(80)}</div>
              </div>
              <div className='language'>
                <div className='languagePic'>
                ...
                <div className='proficiencyDots'>{getProficiencyDots(100)}</div>
              </div>
              <div className='language'>
                <div className='languagePic'>
              ...
              <div className='language'>
                ...
                <span className='languageText'>SQL</span>
                <div className='proficiencyDots'>{getProficiencyDots(60)}</div>
              </div>
            </div>
          </div>
          ...
          <div className='skillsCategory'>
            <h3 className='categoryTitle'>Tools & Technologies</h3>
            <div className='skillsList'>
              <div className='language'>
                <div className='languagePic'>
                  <div className='languageIMG'>
                ...
                <span className='languageText'>Git</span>
                <div className='proficiencyDots'>{getProficiencyDots(100)}</div>
              </div>
              <div className='language'>
                <div className='languagePic'>
                ...
                <span className='languageText'>Linux</span>
                <div className='proficiencyDots'>{getProficiencyDots(80)}</div>
              </div>
              <div className='language'>
                <div className='languagePic'>
                ...
                <span className='languageText'>Docker</span>
                <div className='proficiencyDots'>{getProficiencyDots(40)}</div>
              </div>
              <div className='language'>
                <div className='languagePic'>
                  <div className='languageIMG'>
                ...
                <span className='languageText'>AWS</span>
                <div className='proficiencyDots'>{getProficiencyDots(40)}</div>
              </div>
            </div>
          </div>
          ...
          <div className='skillsCategory'>
            ...
            <div className='skillsList'>
              <div className='language'>
                <div className='languagePic'>
                  <img src={reactIMG} alt="React" className='languageIMG'/>
                </div>
                <span className='languageText'>React</span>
                <div className='proficiencyDots'>{getProficiencyDots(80)}</div>
              </div>
              <div className='language'>
                <div className='languagePic'>
                ...
                <span className='languageText'>Node.js</span>
                <div className='proficiencyDots'>{getProficiencyDots(80)}</div>
              </div>
              <div className='language'>
                <div className='languagePic'>
                ...
                <span className='languageText'>PyTorch</span>
                <div className='proficiencyDots'>{getProficiencyDots(60)}</div>
              </div>
              <div className='language'>
                <div className='languagePic'>
                ...
                <span className='languageText'>NumPy</span>
                <div className='proficiencyDots'>{getProficiencyDots(80)}</div>
              </div>
              <div className='language'>
                <div className='languagePic'>
                ...
                <span className='languageText'>Django</span>
                <div className='proficiencyDots'>{getProficiencyDots(40)}</div>
              </div>
            </div>
          </div>
        ...
        <div className='skillsLegend'>
          <div className='legendTitle'>Proficiency Levels:</div>
          <div className='legendItems'>
            <div className='legendItem'><span className='legendDot'>●</span> Familiar</div>
            <div className='legendItem'><span className='legendDot'>●●</span> Basic</div>
            <div className='legendItem'><span className='legendDot'>●●●</span> Intermediate</div>
            <div className='legendItem'><span className='legendDot'>●●●●</span> Advanced</div>
            <div className='legendItem'><span className='legendDot'>●●●●●</span> Master</div>
          </div>
        </div>
      </section>
    </>
