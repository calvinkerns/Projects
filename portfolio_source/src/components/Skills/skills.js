...
const Skills = () => {
  ...
  // Helper function to convert percentage to dots (1-3)
  const getProficiencyDots = (percentage) => {
    const dots = Math.round((percentage / 100) * 3) || 1;
      ...
      <section id='proficiency' ref={sectionRef} className={isVisible ? 'visible' : ''}>
        ...
        <div className='skillsLegend'>
          ...
          <div className='legendItems'>
            <div className='legendItem'><span className='legendDot'>●</span> Tried It</div>
            <div className='legendItem'><span className='legendDot'>●●</span> Comfortable</div>
            <div className='legendItem'><span className='legendDot'>●●●</span> Know It Well</div>
          </div>
        </div>
      </section>
    </>
